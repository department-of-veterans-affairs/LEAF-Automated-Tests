...
('ApproveandPost',	'Approve and Post',	'Approved and Posted',	'go-next.svg',	'right',	0,	1,	0),
('Archive',	'Archive',	'Archived',	'document-open.svg',	'right',	0,	1,	0),
('changeInitiator',	'Change Initiator',	'Changed Initiator',	'',	'',	0,	0,	0),
('ClosingforResolution',	'Closing for Resolution ',	'Closed for Resolution ',	'applications-office.svg',	'right',	0,	1,	0),
('concur',	'Concur',	'Concurred',	'go-next.svg',	'right',	1,	1,	0),
('defer',	'Defer',	'Deferred',	'software-update-urgent.svg',	'left',	0,	-2,	0),
('DeferandHold',	'Defer and Hold',	'Deferred - On hold',	'go-next.svg',	'right',	0,	1,	0),
('deleted',	'Cancel',	'Cancelled',	'',	'',	0,	0,	0),
('disapprove',	'Disapprove',	'Disapproved',	'process-stop.svg',	'left',	0,	-1,	0),
('DuplicateDisapprove',	'Duplicate - Disapprove',	'Duplicate - Disapproved',	'go-next.svg',	'right',	0,	1,	0),
('move',	'Change Step',	'Changed Step',	'',	'',	0,	0,	0),
('Notes',	'Notes',	'Added Note',	'accessories-text-editor.svg',	'right',	0,	1,	0),
('Processnotselected',	'Process not selected',	'Process not selected',	'edit-cut.svg',	'right',	0,	1,	0),
('ProcesstoaddtoLibrary',	'Process to add to Library',	'Processed to add to Library',	'go-next.svg',	'right',	0,	1,	0),
('ReturntoReview',	'Return to Review',	'Review Returned',	'edit-redo.svg',	'right',	0,	1,	0),
('Review',	'Review',	'Reviewed',	'dialog-apply.svg',	'right',	0,	1,	0),
...
('form_25dfe',	'',	'Interior Design Request Form (Copy)',	'',	0,	0,	1,	133,	1,	1,	'',	NULL,	0),
('form_68aa4',	'',	'Form',	'',	1,	0,	0,	NULL,	1,	0,	'',	NULL,	1587071998),
('form_6d6bc',	'',	'Interior Design Request (Copy)',	'Request for new, additional, or removal of furniture and Interior Design accessories.',	0,	0,	1,	119,	1,	1,	'',	NULL,	0),
('form_81e1b',	'',	'National Site Template',	'Standardized templates for LEAF sites',	0,	0,	1,	NULL,	1,	1,	'',	NULL,	0),
('form_8512b',	'form_68aa4',	'Metadata',	'',	0,	0,	0,	NULL,	1,	0,	'',	NULL,	1584455165),
...
(2,	'Approved and Posted',	'CustomEvent_Form_Selected_emailTo.tpl',	'CustomEvent_Form_Selected_emailCc.tpl',	'CustomEvent_Form_Selected_subject.tpl',	'CustomEvent_Form_Selected_body.tpl'),
(3,	'Processed not selected',	'CustomEvent_Form_Not_Selected_emailTo.tpl',	'CustomEvent_Form_Not_Selected_emailCc.tpl',	'CustomEvent_Form_Not_Selected_subject.tpl',	'CustomEvent_Form_Not_Selected_body.tpl'),
(4,	'Request received',	'CustomEvent_Request_Received_emailTo.tpl',	'CustomEvent_Request_Received_emailCc.tpl',	'CustomEvent_Request_Received_subject.tpl',	'CustomEvent_Request_Received_body.tpl');
...
('CustomEvent_Form_Not_Selected',	'Processed not selected',	'Email',	'{\"NotifyRequestor\":\"true\",\"NotifyNext\":\"false\",\"NotifyGroup\":\"None\"}'),
('CustomEvent_Form_Selected',	'Approved and Posted',	'Email',	'{\"NotifyRequestor\":\"true\",\"NotifyNext\":\"false\",\"NotifyGroup\":\"None\"}'),
('CustomEvent_Request_Received',	'Request received',	'Email',	'{\"NotifyRequestor\":\"true\",\"NotifyNext\":\"false\",\"NotifyGroup\":\"None\"}'),
...
CREATE TABLE `indicators` (
  ...
  KEY `categoryID` (`categoryID`),
  KEY `sort` (`sort`),
  CONSTRAINT `indicators_ibfk_1` FOREIGN KEY (`categoryID`) REFERENCES `categories` (`categoryID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
(1,	'<p><strong>LEAF Form Packet</strong></p><p>To generate the Form Packet file:</p><ol><li>Open your Form Editor</li><li>Select your Form</li><li>Click \"Export Form\"<br></li></ol>',	'fileupload',	'LEAF Form Packet',	'',	NULL,	'form_68aa4',	'',	'',	NULL,	NULL,	1,	-128,	'2016-10-11 17:07:32',	0,	0,	1),
(2,	'Classification',	'',	'',	'',	NULL,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-127,	'2016-10-11 17:32:37',	0,	0,	1),
(3,	'Business Line',	'checkboxes\nAdministrative\nClinic Profile Mang. or Cancellation\nFiscal\nHealth Informatics\nHuman Resources\nInformation Technology\nLogistics\nOther',	'',	'',	2,	'form_68aa4',	'',	'',	NULL,	NULL,	1,	-127,	'2016-10-11 17:40:37',	0,	0,	1),
(4,	'Keywords to help describe this form',	'text',	'',	'',	2,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-126,	'2016-10-11 17:41:18',	0,	0,	1),
(5,	'<p>Short Description (5-15 words)</p><p><em> This will be shown as a concise sub-title for the form on the Leaf Library.</em></p>',	'textarea',	'',	'',	1,	'form_68aa4',	'',	'',	NULL,	NULL,	1,	-128,	'2016-10-11 17:45:50',	0,	0,	1),
(6,	'<p>Screenshot of Workflow\n</p><p><em>(jpeg and png files preferred)</em></p>',	'image',	'',	'',	1,	'form_68aa4',	'',	'',	NULL,	NULL,	1,	-127,	'2016-10-14 14:53:15',	0,	0,	1),
(7,	'Long Description / Developer Notes (optional)  ',	'textarea',	'',	'',	1,	'form_68aa4',	'',	'',	NULL,	NULL,	0,	-125,	'2017-01-03 14:53:03',	0,	0,	1),
(8,	'Attribution',	'',	'',	'',	NULL,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-126,	'2017-01-04 20:19:38',	0,	0,	1),
(9,	'<p>Who is the Author of the form?&nbsp;</p><p><em>The&nbsp;form author will be displayed on the LEAF Library. To be anonymous, type anonymous.</em>&nbsp;</p>',	'text',	'',	'',	8,	'form_68aa4',	'',	'',	NULL,	NULL,	1,	-128,	'2017-01-04 20:20:20',	0,	0,	1),
(10,	'Please list any collaborators:',	'text',	'',	'',	9,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-128,	'2017-01-04 20:20:53',	0,	0,	1),
(11,	'<p>What is the Author\'s facility or program office?&nbsp;</p><p>&nbsp; \n<em>To be anonymous, type anonymous.</em></p>',	'text',	'',	'',	10,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	1,	-128,	'2017-01-04 20:21:53',	0,	0,	1),
(12,	'Description',	'textarea',	'',	'',	NULL,	'form_81e1b',	'',	'',	NULL,	NULL,	0,	-128,	'2017-11-24 17:10:49',	0,	1,	1),
(13,	'Data',	'',	'',	'',	NULL,	'form_81e1b',	NULL,	NULL,	NULL,	NULL,	0,	-127,	'2017-11-24 20:05:27',	0,	0,	1),
(14,	'LEAF Form',	'fileupload',	'',	'',	13,	'form_81e1b',	'',	'',	NULL,	NULL,	0,	-128,	'2017-11-24 20:05:54',	0,	0,	1),
(15,	'LEAF Workflow',	'fileupload',	'',	'',	13,	'form_81e1b',	NULL,	NULL,	NULL,	NULL,	0,	-127,	'2017-11-24 20:06:21',	0,	0,	1),
(16,	'Templates',	'fileupload',	'',	'',	13,	'form_81e1b',	NULL,	NULL,	NULL,	NULL,	0,	-126,	'2017-11-24 20:07:05',	0,	0,	1),
(17,	'Admin Templates',	'fileupload',	'',	'',	13,	'form_81e1b',	NULL,	NULL,	NULL,	NULL,	0,	-125,	'2017-11-24 20:07:13',	0,	0,	1),
(18,	'Reports',	'fileupload',	'',	'',	13,	'form_81e1b',	NULL,	NULL,	NULL,	NULL,	0,	-124,	'2017-11-24 20:07:19',	0,	0,	1),
(19,	'Support documentation',	'fileupload',	'',	'',	1,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-124,	'2018-06-04 16:17:23',	0,	0,	1),
(20,	'LEAF Site URL where form is housed',	'text',	'',	'',	2,	'form_68aa4',	NULL,	'<script>$(function() {\n  var url = $(\'#data_{{ iID }}_1\').html();\n  $(\'#data_{{ iID }}_1\').html(\'<a href=\"\'+ url +\'\"target=\"_blank\">\'+ url +\'</a>\');\n  });</script>',	NULL,	NULL,	1,	-128,	'2018-12-05 21:24:20',	0,	0,	1),
(21,	'Requestor Information',	'',	'',	'',	NULL,	'form_25dfe',	NULL,	NULL,	NULL,	NULL,	0,	0,	'2019-02-06 17:27:36',	0,	0,	1),
(22,	'Requestor Name',	'orgchart_employee',	NULL,	'',	21,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(23,	'Supervisor\'s Name',	'orgchart_employee',	NULL,	'',	22,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(24,	'Location of Request-Building Number',	'text',	NULL,	'',	21,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(25,	'Location of Request-Room Number',	'text',	NULL,	'',	21,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(26,	'Phone Extension',	'text',	NULL,	'',	21,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(27,	'<p>Interior Design Options\nPlease&nbsp;read this&nbsp;prior to completing&nbsp;your request:&nbsp;&nbsp;&nbsp; <a href=\"J:\\MOUPublic\\Interior Design LEAF\\Interior Design Information-PLEASE READ.docx\" target=\"_blank\">Interior Design Information</a></p>',	'',	'',	'',	NULL,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	0,	'2019-02-06 17:27:36',	0,	0,	1),
(28,	'Furniture-Seating\nCLICK LINK to see options:&nbsp;&nbsp; <a href=\"\\\\v09.med.va.gov\\mou\\Public\\MOUPublic\\LEAF\\Interior Design Request Form\\Interior Design Request Form_Supplemental Document-Seating.pdf\" target=\"_blank\">SEATING OPTIONS</a>',	'checkboxes\r\nDesk/Task\r\nGuest, Arm\r\nGuest, Armless\r\nGuest, Bariatric\r\nConference\r\nWork Stool\r\nExam Stool\r\nWaiting Room Seating\r\nOther\r\nNone',	NULL,	'',	27,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(29,	'If OTHER, please explain.',	'text',	NULL,	'',	28,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(30,	'Furniture-Storage/Filing\nCLICK LINK to see options:&nbsp;&nbsp; <a href=\"\\\\v09.med.va.gov\\mou\\Public\\MOUPublic\\LEAF\\Interior Design Request Form\\Interior Design Request Form_Supplemental Document-Filing and Storage.pdf\" target=\"_blank\">FILING AND STORAGE OPTIONS</a>',	'checkboxes\r\nLateral File\r\nVertical File\r\nUnder-Desk, 2-Drawer File\r\nUnder-Desk, 3-Drawer File\r\nBookcase\r\nOther\r\nNone',	NULL,	'',	27,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(31,	'If OTHER, please explain.',	'text',	NULL,	'',	30,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(32,	'Furniture-Desking\nCLICK LINK to see options:&nbsp; <a href=\"\\\\v09.med.va.gov\\mou\\Public\\MOUPublic\\LEAF\\Interior Design Request Form\\Interior Design Request Form_Supplemental Document-Desking.pdf\" target=\"_blank\">DESKING OPTIONS</a>',	'checkboxes\r\nL-Shape Desk\r\nU-Shape Desk\r\nStraight Desk\r\nOther\r\nNone',	NULL,	'',	27,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(33,	'If OTHER, please explain.',	'text',	NULL,	'',	32,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(34,	'Furniture-Other\nCLICK LINK to see options:&nbsp; <a href=\"\\\\v09.med.va.gov\\mou\\Public\\MOUPublic\\LEAF\\Interior Design Request Form\\Interior Design Request Form_Supplemental Document-Miscellaneous.pdf\" target=\"_blank\">MISC OPTIONS</a>',	'checkboxes\r\nMedical Supply Cart\r\nOver-bed Table\r\nBedside Table/Nightstand\r\nConference Table\r\nWall Accessory-Clock\r\nWall Accessory-Calendar Board\r\nWall Accessory-Coat Hook\r\nWall Accessory-Whiteboard\r\nOther\r\nNone',	NULL,	'',	27,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(35,	'If OTHER, please explain.',	'text',	NULL,	'',	34,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(36,	'Additional Interior Design Items',	'checkboxes\r\nArtwork\r\nFlooring Replacement\r\nRemoval of Furniture\r\nRepair of Furniture\r\nSignage Update\r\nWindow Shades\r\nWorkspace Reconfiguration\r\nOther\r\nNone',	NULL,	'',	27,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(37,	'Please describe need/s, including quantities if applicable.',	'textarea',	NULL,	'',	36,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:36',	0,	0,	1),
(38,	'If OTHER, please explain.',	'text',	NULL,	'',	36,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	1,	'2019-02-06 17:27:37',	0,	0,	1),
(39,	'Justification for Interior Design Request',	'textarea',	'',	'',	NULL,	'form_25dfe',	'',	'',	NULL,	NULL,	1,	0,	'2019-02-06 17:27:37',	0,	0,	1),
(40,	'Photo of Area of Request-if you have a VA issued device, please include photo of area that pertains to Interior Design request (i.e. image of existing sign to update, office furniture to replace, room to reconfigure, etc.)',	'image',	'',	'',	NULL,	'form_25dfe',	'',	'',	NULL,	NULL,	0,	0,	'2019-02-06 17:27:37',	0,	0,	1),
(41,	'<p>PERTINENT INFORMATION:\n</p><ul><li>1. We are here to assist you if you need help \'problem solving\' your functional working office space. Complete the form and appointments will be made to work on your space.</li><li>2. For ergonomic evaluations contact VA Industrial Hygienist Jeannie Nordstorm at x 6070</li><li>3. Clocks, calendar boards, dry erase/bulletin boards, monitor arms, and keyboard trays submit a Vista work order. Unless at a CBOC</li><li>4. Non-furniture items i.e. paper holder(s), are available via an office supplycatalog and are purchased through your service clerk.</li><li>5. Floor protector mats can be obtained through EMS at 5449</li><li>6. All Furniture moves and installations are done by contractors, a minimum of 10-15 days is required.</li></ul>',	'',	'',	'',	NULL,	'form_6d6bc',	'',	'',	NULL,	NULL,	0,	10,	'2019-02-06 17:27:59',	0,	0,	1),
(42,	'Point of Contact',	'',	'',	'',	NULL,	'form_6d6bc',	'',	'',	NULL,	NULL,	0,	20,	'2019-02-06 17:27:59',	0,	0,	1),
(43,	'Input Service Line Administrative Officer (AO) or Administrative Support\'s Name',	'orgchart_employee',	NULL,	'',	42,	'form_6d6bc',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(44,	'Need by Date',	'date',	NULL,	'',	42,	'form_6d6bc',	NULL,	NULL,	NULL,	NULL,	0,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(45,	'Phone Extension',	'text',	NULL,	'',	42,	'form_6d6bc',	NULL,	NULL,	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(46,	'Building and Room Number',	'text',	NULL,	'',	42,	'form_6d6bc',	NULL,	NULL,	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(47,	'Basic Interior Design Request',	'',	'',	'',	NULL,	'form_6d6bc',	'',	'',	NULL,	NULL,	0,	30,	'2019-02-06 17:27:59',	0,	0,	1),
(48,	'Basic Request (Select all that apply):',	'checkboxes\r\nNew chair  (Describe what type of chair, ie: desk chair, side chair)\r\nChair replacement\r\nAdditional or Alt. furniture item(s)\r\nFurniture move\r\nRemoval of furniture (EE# items by Logistics)\r\nSignage update\r\nUpholstery repair (Cleaning by EMS)\r\nNew blinds\r\nFlooring replacement\r\nOther',	NULL,	'',	47,	'form_6d6bc',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(49,	'Provide Details that will assist us to better serve you:',	'textarea',	NULL,	'',	47,	'form_6d6bc',	NULL,	NULL,	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(50,	'Design needs by Interior Design',	'',	'',	'',	NULL,	'form_6d6bc',	'',	'',	NULL,	NULL,	0,	40,	'2019-02-06 17:27:59',	0,	0,	1),
(51,	'Would Construction be involved. ',	'text',	NULL,	'',	50,	'form_6d6bc',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(52,	'Provide details that will assist us to better serve you',	'textarea',	NULL,	'',	50,	'form_6d6bc',	'',	'',	NULL,	NULL,	1,	1,	'2019-02-06 17:27:59',	0,	0,	1),
(53,	'Pin to top',	'checkbox\nYes',	'',	'',	NULL,	'form_8512b',	NULL,	NULL,	NULL,	NULL,	0,	-128,	'2020-03-17 14:26:05',	0,	0,	1),
(54,	'Does this form contain custom HTML or JavaScript code?\n\nIf yes, please provide notes.',	'radio\nYes\nNo',	'Custom Code',	'No',	1,	'form_68aa4',	NULL,	NULL,	NULL,	NULL,	0,	-126,	'2020-04-16 21:19:58',	0,	0,	1);
...
(1,	1,	'Processnotselected',	'CustomEvent_Form_Not_Selected'),
(1,	1,	'ApproveandPost',	'CustomEvent_Form_Selected'),
(1,	-1,	'submit',	'CustomEvent_Request_Received'),
...
('emailBCC',	'{}'),
('emailCC',	'{}'),
('heading',	'LEAF Library'),
('leafSecure',	'0'),
('national_linkedPrimary',	''),
('national_linkedSubordinateList',	''),
('orgchartImportTags',	'{\"0\":\"LEAF_library\"}'),
('requestLabel',	'Leaflet'),
...
CREATE TABLE `step_dependencies` (
  ...
  KEY `dependencyID` (`dependencyID`),
  CONSTRAINT `fk_step_dependencyID` FOREIGN KEY (`dependencyID`) REFERENCES `dependencies` (`dependencyID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `step_dependencies_ibfk_3` FOREIGN KEY (`stepID`) REFERENCES `workflow_steps` (`stepID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `workflow_routes` (
  ...
  KEY `stepID` (`stepID`),
  KEY `actionType` (`actionType`),
  CONSTRAINT `workflow_routes_ibfk_1` FOREIGN KEY (`workflowID`) REFERENCES `workflows` (`workflowID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
(-1,	-2,	0,	'approve',	''),
(-1,	-2,	0,	'sendback',	''),
(1,	1,	0,	'ApproveandPost',	''),
(1,	1,	3,	'Archive',	''),
(1,	1,	2,	'DeferandHold',	''),
(1,	1,	1,	'Notes',	''),
(1,	1,	0,	'Processnotselected',	''),
(1,	1,	0,	'sendback',	'{\"required\":\"true\"}'),
(1,	2,	0,	'ClosingforResolution',	''),
(1,	2,	1,	'ProcesstoaddtoLibrary',	''),
(1,	3,	0,	'ClosingforResolution',	''),
(1,	3,	1,	'ReturntoReview',	'');
...
CREATE TABLE `workflow_steps` (
  ...
  CONSTRAINT `workflow_steps_ibfk_1` FOREIGN KEY (`workflowID`) REFERENCES `workflows` (`workflowID`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1,	1,	'Review ',	'#fffdcd',	'black',	'1px solid black',	'',	530,	177,	NULL,	NULL,	NULL,	NULL),
(1,	2,	'Defer and hold',	'#fffdcd',	'black',	'1px solid black',	'',	867,	247,	NULL,	NULL,	NULL,	NULL),
(1,	3,	'Archive',	'#fffdcd',	'black',	'1px solid black',	'',	239,	346,	NULL,	NULL,	NULL,	NULL);
