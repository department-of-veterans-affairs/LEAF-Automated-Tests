...
test('Check inbox visibility on view combined inbox page', async ({ page }) => {
    await page.goto('https://host.docker.internal/Test_Request_Portal/report.php?a=LEAF_sitemaps_template');
...
test('Change and revert sitemap card color from sidenav link', async ({ page }) => {
    ...
    const firstCard = page.locator('#sortable > div:first-child');
...
test('Check inbox visibility from view sitemap page', async ({ page }) => {
    await page.goto('https://host.docker.internal/Test_Request_Portal/report.php?a=LEAF_sitemaps_template');
...
test('Check sitemap card creation and appearance on view sitemap page', async ({ page }) => {
    await page.goto('https://host.docker.internal/Test_Request_Portal/report.php?a=LEAF_sitemaps_template');
